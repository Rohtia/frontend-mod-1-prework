...
// the Object
console.log('There are ' + animals.otters + ' otters at the zoo.');

// Add an animal to the zoo Object, and log the updated Object.
animals.wolves = 5;
console.log('There are ' + animals.wolves + ' wolves at the zoo.');

// Change the value for at least one of your animal keys, and log the updated Object.
console.log('We are adding 2 otters to our zoo.');
animals.otters = animals.otters + 2;
console.log('We now have ' + animals.otters + ' otters.');

// Add another animal to the zoo Object, and log the updated Object.
console.log('We just got 10 birds for our zoo.');
animals.birds = 10;
console.log('We now have ' + animals.birds + ' birds.');
...
*/
var emailInfo = {
  from: 'harwood.j09@gmail.com',
  to: 'jessicas.aloette@gmail.com',
  dateSent: '25/09/2021',
  timeSent: '12:33',
  subjectLine: 'This is a test email.',
  messageBody: 'This is my email. It is a test. Did it work?'
};
...
var emails = [
  ...
  },
  {
    ...
    dateSent: '25/09/2021',
    timeSent: '12:39',
    subjectLine: 'Second email test',
    messageBody: 'The first one worked, here is number two'
  },
  {
    from: 'harwood.j09@gmail.com',
    to: 'jessicas.aloette@gmail.com',
    dateSent: '25/09/2021',
    timeSent: '12:41',
    subjectLine: 'Third email',
    messageBody: 'I think I have this now.'
  }
]
