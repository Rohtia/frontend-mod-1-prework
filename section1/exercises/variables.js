...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  //firstName indicates it should be a name, which would be a string
  //isHungry seems like it'd be as a question, so I gave an answer.
  //numberOfPets I gave a number value
